...
<div class="container">
  <h2>📥 Import Data Artikel</h2>
  <form action="../../../controllers/admin/artikel/import_artikel.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label>Upload file Excel untuk Artikel:</label>
      <input type="file" name="file_excel" accept=".xls,.xlsx" required>
      <a href="index.php" class="btn">🔙 Kembali ke Data Artikel</a>
