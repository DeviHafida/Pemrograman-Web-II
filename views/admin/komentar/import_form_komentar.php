...
<div class="container">
  <h2>📥 Import Data Komentar</h2>
  <form action="../../../controllers/admin/komentar/import_komentar.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label>Upload file Excel untuk Komentar:</label>
      <input type="file" name="file_excel" accept=".xls,.xlsx" required>
      <a href="index.php" class="btn">🔙 Kembali ke Data Komentar</a>
