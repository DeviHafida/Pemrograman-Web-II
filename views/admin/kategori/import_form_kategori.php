...
<div class="container">
  <h2>📥 Import Data Kategori</h2>
  <form action="../../../controllers/admin/kategori/import_kategori.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label>Upload file Excel untuk Kategori:</label>
      <input type="file" name="file_excel" accept=".xls,.xlsx" required>
      <a href="index.php" class="btn">🔙 Kembali ke Data Kategori</a>
