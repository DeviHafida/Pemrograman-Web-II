...
$produk = [
    ...
    "harga" => "Rp124.000,00",
    "gambar" => "smooth-like-butter-bifida-&-5-ceramides-cream-moisturizer.png",
    "merek" => "Hale",
    ...
    "tekstur" => "Krim",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Pelembap krim ini memiliki tekstur lembut seperti butter yang mudah meresap tanpa rasa lengket. Diformulasikan dengan 12% Glycerin untuk hidrasi optimal, 1% Panthenol yang menenangkan dan mempercepat penyembuhan kulit, serta 2% Ceramide NP yang membantu mengunci kelembapan dan memperkuat skin barrier.
Diperkaya dengan 0.1% Allantoin untuk melembutkan dan melindungi kulit, serta Mango Seed Butter yang kaya akan asam lemak esensial dan antioksidan. Kombinasi Olivem1000, Bifida Ferment Lysate, dan Beet Root Extract membantu menjaga keseimbangan kelembapan kulit, melindungi dari kerusakan akibat lingkungan, serta meningkatkan hidrasi yang tahan lama. Dengan formula ringan namun melembapkan secara intens, pelembap ini juga berfungsi sebagai primer untuk menciptakan tampilan makeup yang lebih halus dan tahan lama. Cocok untuk semua jenis kulit, termasuk kulit sensitif, membuat kulit terasa lebih lembut, kenyal, dan sehat sepanjang hari."
];
?>
