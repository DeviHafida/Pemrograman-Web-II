...
$produk = [
    ...
    "harga" => "Rp124.000,00",
    "gambar" => "natural-sublime-facial-cleanser.jpg",
    "merek" => "Avoskin",
    ...
    "tekstur" => "Cair",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Avoskin Natural Sublime Facial Cleanser adalah sabun pembersih wajah dengan low pH formula yang mampu mengangkat kotoran dan minyak hingga ke pori-pori terdalam tanpa menyebabkan kulit terasa kering atau tertarik. Produk ini mengandung berbagai bahan alami berkualitas tinggi seperti Marula Oil, Kale Extract, Cactus Extract, Niacinamide, dan Pentavitin, yang berperan dalam melembapkan, mencerahkan, serta menjaga skin barrier agar tetap sehat. Dengan kandungan ekstrak alami yang dipetik secara manual pada pagi hari untuk menjaga kualitasnya, cleanser ini juga aman digunakan untuk semua jenis kulit, termasuk kulit berminyak, berjerawat, serta ibu hamil dan menyusui. Selain membersihkan wajah secara menyeluruh, Avoskin Natural Sublime Facial Cleanser mengandung Radish Root Ferment Filtrate sebagai natural preservative, serta komposisi kompleks yang efektif membunuh bakteri, termasuk bakteri penyebab maskne atau jerawat akibat penggunaan masker. "
];
?>
