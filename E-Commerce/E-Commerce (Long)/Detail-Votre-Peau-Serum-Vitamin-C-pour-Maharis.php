...
$produk = [
    ...
    "harga" => "Rp385.000,00",
    "gambar" => "votre-peau-serum-vitamin-C-pour-Maharis.jpg",
    "merek" => "Votre Peau",
    "kondisi_kulit" => "Normal Skin Tends to be Dry, Sensitive, Irritated",
    "waktu_penggunaan" => "Pagi Hari",
    "berat_bersih" => "30ml",
    "tekstur" => "Cair",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Vitamin C pour Maharis adalah serum pencerah unggulan dari Votre Peau yang diformulasikan dengan 4 bahan aktif untuk mencerahkan kulit, menyamarkan noda kecoklatan hingga bekas jerawat (PIH & PIE), serta memberikan hidrasi optimal agar kulit tampak lebih cerah dan bercahaya. Mengandung 10% Vitamin C (Ethyl Ascorbic Acid), jenis Vitamin C yang lebih stabil dan minim iritasi, serum ini kaya akan antioksidan dan memiliki manfaat anti-aging untuk menjaga keremajaan kulit. Dilengkapi dengan 3% Tranexamic Acid yang efektif mencerahkan pigmentasi seperti melasma akibat paparan sinar matahari serta bekas jerawat tanpa membuat kulit sensitif. Kandungan 2% Salicylic Acid membantu membersihkan pori-pori tersumbat, mengurangi penumpukan komedo, serta mengangkat sel kulit mati untuk tampilan kulit yang lebih halus. Sementara itu, 1% Hyaluronic Acid dalam bentuk Sodium Hyaluronate berperan sebagai humektan yang menarik dan mengunci kelembapan di dalam kulit, memberikan hidrasi intensif dan menjaga kekenyalan kulit. Dengan pH yang mendekati netral, serum ini aman digunakan bersamaan dengan perawatan kulit lainnya."
];
?>
