...
$produk = [
    ...
    "harga" => "Rp299.000,00",
    "gambar" => "miraculous-retinol-ampoule.webp",
    "merek" => "Avoskin",
    ...
    "tekstur" => "Gel",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Avoskin Miraculous Retinol Ampoule adalah serum dengan kandungan utama 3% Actosome Retinol, yang lebih ringan dibandingkan retinol lainnya namun tetap efektif dalam merangsang regenerasi sel kulit. Dikombinasikan dengan Vitamin E, Peptide, Ekstrak Pomegranate, dan Ekstrak Green Tea, ampoule ini membantu mencegah tanda-tanda penuaan dini, menyamarkan noda hitam dan garis halus, serta menjaga elastisitas dan kecerahan kulit. Formulanya juga mengandung 0,09% aktif Retinol, 0,1% Hexapeptide, Raspberry Extract, dan asam ellagic, yang bekerja sinergis untuk meningkatkan pergantian sel kulit sehingga kulit tetap sehat dan kenyal.
Cocok untuk semua jenis kulit dan dapat digunakan mulai usia 20 tahun ke atas, ampoule ini dirancang untuk pemakaian malam hari. Untuk hasil optimal, disarankan mengaplikasikan Miraculous Retinol Toner sebelum ampoule ini serta menggunakan sunscreen pada pagi harinya guna melindungi kulit dari paparan sinar matahari. Jika terjadi kemerahan atau iritasi, frekuensi pemakaian dapat disesuaikan. Dengan pemakaian rutin, kulit akan tampak lebih halus, kencang, dan bercahaya."
];
?>
