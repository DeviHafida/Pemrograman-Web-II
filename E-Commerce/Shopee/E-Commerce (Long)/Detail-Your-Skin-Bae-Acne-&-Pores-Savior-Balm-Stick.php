...
$produk = [
    ...
    "harga" => "Rp1694.000,00",
    "gambar" => "your-skin-bae-acne-&-pores-savior-balm-stick.jpg",
    "merek" => "Avoskin",
    ...
    "tekstur" => "Cair",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Multi balm ini merupakan solusi praktis untuk menjaga kelembapan kulit sekaligus merawat berbagai permasalahan kulit seperti kulit kering, berjerawat, dan tampilan pori-pori yang terlihat besar. Dengan kandungan utama 0.5% 4-Terpineol, 0.5% Salicylic Acid, dan 0.1% Tocopheryl Acetate, balm ini tidak hanya membantu menghidrasi kulit secara mendalam, tetapi juga bekerja aktif dalam merawat kulit berjerawat, menyamarkan pori-pori, serta menutrisi kulit agar tampak lebih bersih, halus, dan cerah. Memiliki tekstur yang lembut dan ringan, moisturizing stick balm ini mudah diaplikasikan tanpa rasa lengket, menjadikannya pilihan ideal untuk penggunaan sehari-hari. Balm ini juga kaya akan antioksidan yang membantu melindungi kulit dari efek buruk lingkungan. Dengan manfaat yang menyeluruh, multi balm ini dapat digunakan sebelum makeup untuk hasil yang lebih flawless, setelah skincare rutin untuk mengunci kelembapan, atau kapan pun kulit membutuhkan hidrasi tambahan, terutama saat berada di ruangan ber-AC, di bawah sinar matahari, atau saat bepergian."
];
?>
