...
$produk = [
    ...
    "harga" => "Rp185.000,00",
    "gambar" => "votre-peau-serum-peptide-concentrate.avif",
    "merek" => "Votre Peau",
    "kondisi_kulit" => "Ideal For Normal Skin That Tends To Be Dry, With Concerns About Fine Lines.",
    "waktu_penggunaan" => "Pagi hari dan Malam hari",
    "berat_bersih" => "30ml",
    "tekstur" => "Cair",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Serum Peptide Concentrate adalah serum anti-aging yang diformulasikan dengan teknologi Hexa-peptide Argireline, yang telah teruji secara klinis dalam membantu menyamarkan tanda-tanda penuaan, khususnya garis halus yang muncul akibat ekspresi wajah, seperti pada garis senyum, kening, dan sudut luar mata. Dengan kandungan utama Argireline Peptide (Hexa-peptide), serum ini bekerja efektif untuk mengurangi tampilan garis halus tanpa perlu tindakan injeksi, menjadikannya solusi yang lebih praktis dan nyaman bagi mereka yang ingin menjaga keremajaan kulit. Selain itu, serum ini juga membantu meratakan warna kulit, mengencangkan, serta memberikan kelembapan optimal.
Dengan pemakaian rutin, Serum Peptide Concentrate memberikan manfaat menyeluruh dalam perawatan kulit, mulai dari meningkatkan elastisitas hingga menjaga keseimbangan hidrasi, yang sangat penting untuk mempertahankan tampilan kulit yang lebih kenyal dan halus. Formulanya ringan dan mudah menyerap. Dengan kombinasi bahan aktif yang bekerja secara sinergis, serum ini menjadi pilihan tepat bagi mereka yang ingin menjaga kulit tetap awet muda dan tampak lebih segar."
];
?>
