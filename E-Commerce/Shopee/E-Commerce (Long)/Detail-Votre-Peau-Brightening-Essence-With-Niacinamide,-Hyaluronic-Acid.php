...
$produk = [
    ...
    "harga" => "Rp249.000,00",
    "gambar" => "votre-peau-brightening-essence-with-niacinamide-hyaluronic-acid.png",
    "merek" => "Votre Peau",
    ...
    "tekstur" => "Cair",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Brightening Essence adalah pre-serum essence yang diformulasikan dengan berbagai bahan aktif untuk membantu mencerahkan, melembapkan, dan memperbaiki tekstur kulit, sehingga kulit tampak lebih sehat dan bercahaya. Mengandung Rice Ferment Filtrate dari fermentasi beras yang kaya mineral, vitamin, dan enzim, essence ini membantu menyamarkan flek hitam, meratakan warna kulit, serta meningkatkan kecerahan alami kulit. Hyaluronic Acid berperan sebagai humektan yang memberikan kelembapan ekstra, menangkap dan mengunci hidrasi agar kulit tetap kenyal serta lebih optimal dalam menyerap rangkaian skincare selanjutnya. Sementara itu, Niacinamide atau Vitamin B3 bekerja efektif dalam meregulasi sebum, memperkuat lapisan pelindung kulit, serta melindungi dari radikal bebas.
Essence ini cocok untuk semua jenis kulit dan aman digunakan bersama rangkaian produk Votre Peau lainnya. Dengan pemakaian rutin, kulit terasa lebih lembut, lembap, dan bercahaya."
];
?>
