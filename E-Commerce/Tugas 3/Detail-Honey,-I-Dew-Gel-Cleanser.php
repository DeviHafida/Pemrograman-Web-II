...
$produk = [
    ...
    "harga" => "Rp124.000,00",
    "gambar" => "hale-honey-i-dew-gel-cleanser.png",
    "merek" => "Hale",
    ...
    "tekstur" => "Gel",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Pembersih wajah ini dirancang untuk semua orang, baik pria maupun wanita, dari segala usia. Formula lembutnya efektif membersihkan kulit dari minyak, kotoran, dan sisa makeup tanpa membuat kulit terasa kering. Selain itu, pembersih ini juga membantu menjaga kesehatan skin barrier, sehingga kulit tetap terhidrasi dan seimbang. Menggunakan agen pembersih biodegradable yang tidak mengeringkan kulit, produk ini memiliki pH rendah (5.0–6.0) yang sesuai dengan pH alami kulit, sehingga membantu menjaga skin barrier tetap sehat. Dilengkapi dengan ekstrak madu yang bersifat antibakteri dan antijamur, pembersih ini juga membantu menenangkan kulit dan melindunginya dari iritasi. Formulanya dibuat khusus untuk kulit sensitif, bebas dari pewangi, essential oil, alkohol sederhana, serta paraben, sehingga aman digunakan sehari-hari. Kandungan utamanya meliputi Sodium Methyl Cocoyl Taurate dan Cocamidopropyl Betaine, dua agen pembersih lembut yang biodegradable dan tidak menyebabkan kulit kering, serta Glycerin dan Ekstrak Madu, yang berperan sebagai hidrator sekaligus pelindung kulit dari bakteri dan jamur."
];
?>
