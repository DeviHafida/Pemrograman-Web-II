...
$produk = [
    ...
    "harga" => "Rp265.000,00",
    "gambar" => "votre-peau-skin-care-daily-facial-sun-shield-spf-50-pa+++.webp",
    "merek" => "Votre Peau",
    ...
    "tekstur" => "Gel",
    "umur_simpan" => "6 Bulan",
    "deskripsi" => "Daily Facial Sun Shield adalah sunscreen berbentuk gel ringan dengan SPF 50 yang melindungi kulit dari sinar UVA/UVB, blue light, serta polusi tanpa menyumbat pori-pori atau meninggalkan white cast. Diformulasikan dengan Zinc Oxide sebagai physical barrier, Tranexamic Acid untuk mencerahkan pigmentasi, dan Salicylic Acid yang membantu mengurangi komedo, produk ini cocok untuk semua jenis kulit, termasuk kulit berminyak dan berjerawat. Teksturnya ringan, bebas kilap, dan mudah meresap, memberikan perlindungan optimal tanpa rasa lengket. Selain itu, sunscreen ini juga membantu menjaga kelembapan kulit, mencegah tanda-tanda penuaan dini, serta memberikan tampilan kulit yang lebih sehat dan segar. Dengan formula non-komedogenik dan bebas dari alkohol serta paraben, produk ini aman digunakan setiap hari tanpa khawatir menyebabkan iritasi atau penyumbatan pori. Ideal untuk pemakaian sehari-hari, baik saat beraktivitas di dalam maupun luar ruangan."
];
?>
